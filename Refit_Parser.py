...
class Refit_Parser:
    ...
    def load_data(self):
        for house_idx in self.house_indicies:
            filename  = '/kaggle/input/d/alimasaleem/nilm_data/ELECTRIcity_NILM-main/data/Refit/data/House'+str(house_idx)+'.csv'
            labelname = '/kaggle/input/d/alimasaleem/nilm_data/ELECTRIcity_NILM-main/data/Refit/Labels/House'+str(house_idx)+'.txt'
