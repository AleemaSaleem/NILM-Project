...
if __name__ == "__main__":
   ...
   # print(model.state_dict().keys())
    ...
    with open(r'/kaggle/working/NILM-Project/results/uk_dale/dishwasher/results.pkl', 'wb') as f:
        pkl.dump(results, f)
    
    #pkl.dump(results,open( fname, "wb" )) 
        FileLink(r'/kaggle/working/NILM-Project/results/uk_dale/dishwasher/results.pkl')
