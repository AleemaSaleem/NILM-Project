...
if __name__ == "__main__":
    ...
    with open(r'/kaggle/working/NILM-Project/results/redd_lf/dishwasher/results.pkl', 'wb') as f:
        pkl.dump(results, f)
    
    #pkl.dump(results,open( fname, "wb" )) 
        FileLink(r'/kaggle/working/NILM-Project/results/redd_lf/dishwasher/results.pkl')
