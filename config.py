...
def get_args():
    ...
    args.redd_location   = r'/kaggle/input/d/alimasaleem/nilm_data/ELECTRIcity_NILM-main/data/REDD'
    args.refit_location  = r'/kaggle/input/d/alimasaleem/nilm_data/ELECTRIcity_NILM-main/data/Refit'
