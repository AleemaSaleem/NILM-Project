...
class Trainer:
    ...
    def test(self,test_loader):
        ...
        with open(r'/kaggle/working/NILM-Project/results/uk_dale/kettle/test_result.json', 'w') as f:
            json.dump(data, f)
        FileLink(r'/kaggle/working/NILM-Project/results/uk_dale/kettle/test_result.json')
    ...
    def _save_state_dict(self):
        ...
        os.chdir(r'/kaggle/working')
        torch.save(best_acc_model.state_dict(), r'/kaggle/working/NILM-Project/results/uk_dale/kettle/best_acc_model.pth')
        from IPython.display import FileLink
