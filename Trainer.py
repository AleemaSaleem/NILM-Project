...
class Trainer:
    ...
    #    best_f1_prev = best_f1
    #    best_acc_prev = best_acc
    #    best_mre_prev = best_mre
    ...
    def test(self,test_loader):
        ...
        with open(r'/kaggle/working/NILM-Project/results/uk_dale/washing_machine/test_result.json', 'w') as f:
            json.dump(data, f)
        FileLink(r'/kaggle/working/NILM-Project/results/uk_dale/washing_machine/test_result.json')
    ...
    def _save_state_dict(self):
        ...
        os.chdir(r'/kaggle/working')
        torch.save(best_acc_model.state_dict(), r'/kaggle/working/NILM-Project/results/uk_dale/washing_machine/best_acc_model.pth')
        from IPython.display import FileLink
